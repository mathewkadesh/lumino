...
const categories: Category[] = [
  {
    ...
    filterSlug: 'takeaway',
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-kebab-easton.png`,
  },
  {
    id: 'CAT-02',
    ...
    filterSlug: 'cafe',
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-cafe-stokes-croft.png`,
  },
  {
    id: 'CAT-03',
    ...
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-convenience-store-deals.png`,
  },
  {
    id: 'CAT-04',
    ...
    filterSlug: 'premier',
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-premier-gloucester-road.png`,
  },
  {
    id: 'CAT-05',
    ...
    filterSlug: 'barber',
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-barber-st-pauls.png`,
  },
  {
    id: 'CAT-06',
    ...
    filterSlug: 'pizza',
    imageSrc: `${import.meta.env.BASE_URL}img/gallery-pizzeria-dough-evening.png`,
  },
]
